/*
  filename: react.integralui.buttongroup.js
  version : 23.3.0
...
class IntegralUIButtonGroupComponent extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        ...
        if (this.ctrlRef && this.ctrlRef.current){
            if (this.props.buttonPressed)
                this.ctrlRef.current.addEventListener('buttonPressed', (e) => this.props.buttonPressed(e));
    ...
    componentWillUnmount(){
        if (this.ctrlRef && this.ctrlRef.current){
            if (this.props.buttonPressed)
                this.ctrlRef.current.removeEventListener('buttonPressed', this.props.buttonPressed);
            if (this.props.enabledChanged)
    ...
    render(){
        return (
            <iui-buttongroup id={this.props.id} ref={this.ctrlRef}>
                {this.props.children}
            </iui-buttongroup>
        );
    }
