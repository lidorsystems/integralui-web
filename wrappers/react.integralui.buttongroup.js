...
import '../components/integralui.buttongroup.js';
...
var IntegralUIButtonGroupComponent = function (_Component) {
    _inherits(IntegralUIButtonGroupComponent, _Component);

    function IntegralUIButtonGroupComponent(props) {
        _classCallCheck(this, IntegralUIButtonGroupComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIButtonGroupComponent.__proto__ || Object.getPrototypeOf(IntegralUIButtonGroupComponent)).call(this, props));
    ...
    _createClass(IntegralUIButtonGroupComponent, [{
        ...
        value: function componentDidMount() {
            ...
            if (this.ctrlRef && this.ctrlRef.current) {
                if (this.props.buttonPressed) this.ctrlRef.current.addEventListener('buttonPressed', function (e) {
                    return _this2.props.buttonPressed(e);
                });
        ...
        value: function componentWillUnmount() {
            if (this.ctrlRef && this.ctrlRef.current) {
                if (this.props.buttonPressed) this.ctrlRef.current.removeEventListener('buttonPressed', this.props.buttonPressed);
    ...
    return IntegralUIButtonGroupComponent;
}(Component);

export default IntegralUIButtonGroupComponent;