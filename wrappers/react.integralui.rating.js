...
var IntegralUIRatingComponent = function (_Component) {
    _inherits(IntegralUIRatingComponent, _Component);

    function IntegralUIRatingComponent(props) {
        _classCallCheck(this, IntegralUIRatingComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIRatingComponent.__proto__ || Object.getPrototypeOf(IntegralUIRatingComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUIRatingComponent, [{
        key: '_isCtrlDefined',
        ...
        value: function _initProps() {
            if (this._isCtrlDefined()) {
                ...
                if (this._isDefined(this.props.division)) this.ctrlRef.current.division = this.props.division;
                if (this._isDefined(this.props.enabled)) this.ctrlRef.current.enabled = this.props.enabled;
                if (this._isDefined(this.props.increment)) this.ctrlRef.current.increment = this.props.increment;
                ...
                if (this._isDefined(this.props.stepSize)) this.ctrlRef.current.stepSize = this.props.stepSize;
                if (this._isDefined(this.props.tabIndex)) this.ctrlRef.current.tabIndex = this.props.tabIndex;
        ...
        value: function _updateData(prevProps) {
            if (this._isCtrlDefined()) {
                ...
                if (this.props.division !== prevProps.division) this.ctrlRef.current.division = this.props.division;
                if (this.props.enabled !== prevProps.enabled) this.ctrlRef.current.enabled = this.props.enabled;
                if (this.props.increment !== prevProps.increment) this.ctrlRef.current.increment = this.props.increment;
                ...
                if (this.props.stepSize !== prevProps.stepSize) this.ctrlRef.current.stepSize = this.props.stepSize;
                if (this.props.tabIndex !== prevProps.tabIndex) this.ctrlRef.current.tabIndex = this.props.tabIndex;
    ...
    return IntegralUIRatingComponent;
}(Component);
