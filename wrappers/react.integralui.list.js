/*
  filename: react.integralui.list.js
  version : 23.3.0
...
class IntegralUIListComponent extends Component {
    constructor(props){
        super(props);
    ...
    _initProps(){
        if (this._isCtrlDefined()){
            ...
            if (this._isDefined(this.props.maxVisibleItems))
                this.ctrlRef.current.maxVisibleItems = this.props.maxVisibleItems;
    ...
    _updateData(prevProps){
        if (this._isCtrlDefined()){
            ...
            if (this._isDefined(this.props.items))
                this.ctrlRef.current.items = this.props.items;
            if (this.props.maxVisibleItems !== prevProps.maxVisibleItems)
                this.ctrlRef.current.maxVisibleItems = this.props.maxVisibleItems;
    ...
    render(){
        return (
            <iui-list id={this.props.id} ref={this.ctrlRef}>
                {this.props.children}
            </iui-list>
        );
    }
