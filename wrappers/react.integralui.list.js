...
import '../components/integralui.list.js';
...
var IntegralUIListComponent = function (_Component) {
    _inherits(IntegralUIListComponent, _Component);

    function IntegralUIListComponent(props) {
        _classCallCheck(this, IntegralUIListComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIListComponent.__proto__ || Object.getPrototypeOf(IntegralUIListComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUIListComponent, [{
        key: '_isCtrlDefined',
        ...
        value: function _initProps() {
            if (this._isCtrlDefined()) {
                ...
                if (this._isDefined(this.props.maxVisibleItems)) this.ctrlRef.current.maxVisibleItems = this.props.maxVisibleItems;
        ...
        value: function _updateData(prevProps) {
            if (this._isCtrlDefined()) {
                ...
                if (this._isDefined(this.props.items)) this.ctrlRef.current.items = this.props.items;
                if (this.props.maxVisibleItems !== prevProps.maxVisibleItems) this.ctrlRef.current.maxVisibleItems = this.props.maxVisibleItems;
        ...
        key: 'scrollTo',
        value: function scrollTo(item, direction) {
            return this._isCtrlDefined() ? this.ctrlRef.current.scrollTo(item, direction) : { x: 0, y: 0 };
        }
    ...
    return IntegralUIListComponent;
}(Component);

export default IntegralUIListComponent;