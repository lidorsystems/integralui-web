...
import '../components/integralui.tooltip.js';
...
var IntegralUITooltipComponent = function (_Component) {
    _inherits(IntegralUITooltipComponent, _Component);

    function IntegralUITooltipComponent(props) {
        _classCallCheck(this, IntegralUITooltipComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUITooltipComponent.__proto__ || Object.getPrototypeOf(IntegralUITooltipComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUITooltipComponent, [{
        key: '_isCtrlDefined',
    ...
    return IntegralUITooltipComponent;
}(Component);

export default IntegralUITooltipComponent;