...
import '../components/integralui.splitter.js';
...
var IntegralUISplitterComponent = function (_Component) {
    _inherits(IntegralUISplitterComponent, _Component);

    function IntegralUISplitterComponent(props) {
        _classCallCheck(this, IntegralUISplitterComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUISplitterComponent.__proto__ || Object.getPrototypeOf(IntegralUISplitterComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUISplitterComponent, [{
        key: '_isCtrlDefined',
    ...
    return IntegralUISplitterComponent;
}(Component);

export default IntegralUISplitterComponent;