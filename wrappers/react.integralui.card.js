...
class IntegralUICardComponent extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        ...
        if (this.ctrlRef && this.ctrlRef.current){
            ...
            if (this.props.touchStart)
                this.ctrlRef.current.addEventListener('touchStart', (e) => this.props.touchStart(e));
       }
    }
    ...
    componentWillUnmount(){
        if (this.ctrlRef && this.ctrlRef.current){
            ...
            if (this.props.touchStart)
                this.ctrlRef.current.removeEventListener('touchStart', this.props.touchStart);
        }
    }
    ...
    _initProps(){
        if (this.ctrlRef && this.ctrlRef.current){
            ...
            if (this._isDefined(this.props.flipped))
                this.ctrlRef.current.flipped = this.props.flipped;
            if (this._isDefined(this.props.footer))
                this.ctrlRef.current.footer = this.props.footer;
            if (this._isDefined(this.props.header))
                this.ctrlRef.current.header = this.props.header;
    ...
    render(){
        return (
            <iui-card id={this.props.id} ref={this.ctrlRef}>
                {this.props.children}
            </iui-card>
        );
    }
