...
import '../components/integralui.menu.js';
...
var IntegralUIMenuComponent = function (_Component) {
    _inherits(IntegralUIMenuComponent, _Component);

    function IntegralUIMenuComponent(props) {
        _classCallCheck(this, IntegralUIMenuComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIMenuComponent.__proto__ || Object.getPrototypeOf(IntegralUIMenuComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUIMenuComponent, [{
        key: '_isCtrlDefined',
        ...
        value: function _updateData(prevProps) {
            if (this._isCtrlDefined()) {
                ...
                if (this.props.items !== prevProps.items) this.ctrlRef.current.items = this.props.items;
                if (this._isDefined(this.props.itemTemplate)) this.ctrlRef.current.itemTemplate = this.props.itemTemplate;
    ...
    return IntegralUIMenuComponent;
}(Component);

export default IntegralUIMenuComponent;