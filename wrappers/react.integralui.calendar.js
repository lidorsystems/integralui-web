...
import '../components/integralui.calendar.js';
...
var IntegralUICalendarComponent = function (_Component) {
    _inherits(IntegralUICalendarComponent, _Component);

    function IntegralUICalendarComponent(props) {
        _classCallCheck(this, IntegralUICalendarComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUICalendarComponent.__proto__ || Object.getPrototypeOf(IntegralUICalendarComponent)).call(this, props));
    ...
    _createClass(IntegralUICalendarComponent, [{
        ...
        value: function _initProps() {
            if (this.ctrlRef && this.ctrlRef.current) {
                ...
                if (this._isDefined(this.props.showToday)) this.ctrlRef.current.showToday = this.props.showToday;
                ...
                if (this._isDefined(this.props.todayDate)) this.ctrlRef.current.todayDate = this.props.todayDate;
            }
        }
    }, {
        key: '_isDefined',
        ...
        value: function _updateData(prevProps) {
            if (this.ctrlRef && this.ctrlRef.current) {
                ...
                if (this.props.showToday !== prevProps.showToday) this.ctrlRef.current.showToday = this.props.showToday;
                ...
                if (this.props.todayDate !== prevProps.todayDate) this.ctrlRef.current.todayDate = this.props.todayDate;
            }
        }
    ...
    return IntegralUICalendarComponent;
}(Component);

export default IntegralUICalendarComponent;