...
var IntegralUILoadingComponent = function (_Component) {
    _inherits(IntegralUILoadingComponent, _Component);

    function IntegralUILoadingComponent(props) {
        _classCallCheck(this, IntegralUILoadingComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUILoadingComponent.__proto__ || Object.getPrototypeOf(IntegralUILoadingComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUILoadingComponent, [{
        key: '_isCtrlDefined',
        ...
        value: function componentDidMount() {
            ...
            if (this.ctrlRef && this.ctrlRef.current) {
                ...
                if (this.props.loadComplete) this.ctrlRef.current.addEventListener('loadComplete', function (e) {
                    return _this2.props.loadComplete(e);
                });
        ...
        value: function endLoad() {
            if (this.ctrlRef && this.ctrlRef.current) this.ctrlRef.current.endLoad();
        }
    }, {
        key: 'updateProgress',
        value: function updateProgress() {
            if (this.ctrlRef && this.ctrlRef.current) this.ctrlRef.current.updateProgress();
        }
    ...
    return IntegralUILoadingComponent;
}(Component);
