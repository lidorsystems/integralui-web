...
var IntegralUIAutoCompleteComponent = function (_Component) {
    _inherits(IntegralUIAutoCompleteComponent, _Component);

    function IntegralUIAutoCompleteComponent(props) {
        _classCallCheck(this, IntegralUIAutoCompleteComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIAutoCompleteComponent.__proto__ || Object.getPrototypeOf(IntegralUIAutoCompleteComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUIAutoCompleteComponent, [{
        key: '_isCtrlDefined',
        ...
        value: function _initProps() {
            if (this._isCtrlDefined()) {
                ...
                if (this._isDefined(this.props.list)) this.ctrlRef.current.list = this.props.list;
                ...
                if (this._isDefined(this.props.placeHolder)) this.ctrlRef.current.placeHolder = this.props.placeHolder;
        ...
        value: function _updateData(prevProps) {
            if (this._isCtrlDefined()) {
                ...
                if (this.props.placeHolder !== prevProps.placeHolder) this.ctrlRef.current.placeHolder = this.props.placeHolder;
    ...
    return IntegralUIAutoCompleteComponent;
}(Component);
