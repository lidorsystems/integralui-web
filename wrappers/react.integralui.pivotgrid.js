...
var IntegralUIPivotGridComponent = function (_Component) {
    _inherits(IntegralUIPivotGridComponent, _Component);

    function IntegralUIPivotGridComponent(props) {
        _classCallCheck(this, IntegralUIPivotGridComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIPivotGridComponent.__proto__ || Object.getPrototypeOf(IntegralUIPivotGridComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUIPivotGridComponent, [{
        key: '_isCtrlDefined',
        ...
        value: function componentDidMount() {
            ...
            if (this._isCtrlDefined()) {
                ...
                if (this.props.columnAdded) this.ctrlRef.current.addEventListener('columnAdded', function (e) {
                    return _this2.props.columnAdded(e);
                });
        ...
        value: function _initProps() {
            if (this._isCtrlDefined()) {
                ...
                if (this._isDefined(this.props.filters)) this.ctrlRef.current.filters = this.props.filters;
                ...
                if (this._isDefined(this.props.showTotal)) this.ctrlRef.current.showTotal = this.props.showTotal;
                ...
                if (this._isDefined(this.props.values)) this.ctrlRef.current.values = this.props.values;
            }
        }
    }, {
        key: '_isDefined',
        ...
        value: function _updateData(prevProps) {
            if (this._isCtrlDefined()) {
                ...
                if (this.props.showTotal !== prevProps.showTotal) this.ctrlRef.current.showTotal = this.props.showTotal;
        ...
        key: 'exportToJSON',
        value: function exportToJSON(columnFields, rowFields, spacing) {
    ...
    return IntegralUIPivotGridComponent;
}(Component);
