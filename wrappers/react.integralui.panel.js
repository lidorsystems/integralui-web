/*
  filename: react.integralui.panel.js
  version : 23.3.0
...
class IntegralUIPanelComponent extends Component {
    constructor(props){
        super(props);
    ...
    _initProps(){
        if (this.ctrlRef && this.ctrlRef.current){
           ...
           if (this._isDefined(this.props.contentAlignment))
                this.ctrlRef.current.contentAlignment = this.props.contentAlignment;
    ...
    _updateData(prevProps){
        if (this.ctrlRef && this.ctrlRef.current){
            ...
            if (this.props.colorScheme !== prevProps.colorScheme)
                this.ctrlRef.current.colorScheme = this.props.colorScheme;
            if (this.props.contentAlignment !== prevProps.contentAlignment)
                this.ctrlRef.current.contentAlignment = this.props.contentAlignment;
    ...
    render(){
        return (
            <iui-panel id={this.props.id} ref={this.ctrlRef}>
                {this.props.children}
            </iui-panel>
        );
    }
