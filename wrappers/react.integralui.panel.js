...
import '../components/integralui.panel.js';
...
var IntegralUIPanelComponent = function (_Component) {
    _inherits(IntegralUIPanelComponent, _Component);

    function IntegralUIPanelComponent(props) {
        _classCallCheck(this, IntegralUIPanelComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIPanelComponent.__proto__ || Object.getPrototypeOf(IntegralUIPanelComponent)).call(this, props));
    ...
    _createClass(IntegralUIPanelComponent, [{
        ...
        value: function _initProps() {
            if (this.ctrlRef && this.ctrlRef.current) {
                ...
                if (this._isDefined(this.props.contentAlignment)) this.ctrlRef.current.contentAlignment = this.props.contentAlignment;
        ...
        value: function _updateData(prevProps) {
            if (this.ctrlRef && this.ctrlRef.current) {
                ...
                if (this.props.contentAlignment !== prevProps.contentAlignment) this.ctrlRef.current.contentAlignment = this.props.contentAlignment;
    ...
    return IntegralUIPanelComponent;
}(Component);

export default IntegralUIPanelComponent;