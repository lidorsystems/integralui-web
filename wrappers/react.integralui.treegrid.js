...
import '../components/integralui.treegrid.js';
...
var IntegralUITreeGridComponent = function (_Component) {
    _inherits(IntegralUITreeGridComponent, _Component);

    function IntegralUITreeGridComponent(props) {
        _classCallCheck(this, IntegralUITreeGridComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUITreeGridComponent.__proto__ || Object.getPrototypeOf(IntegralUITreeGridComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUITreeGridComponent, [{
        key: '_isCtrlDefined',
        ...
        key: 'loadData',
        value: function loadData(data, parent, fields, flat, incremental) {
            if (this._isCtrlDefined()) this.ctrlRef.current.loadData(data, parent, fields, flat, incremental);
        }
    }, {
        key: 'removeColumn',
    ...
    return IntegralUITreeGridComponent;
}(Component);

export default IntegralUITreeGridComponent;