/*
  filename: react.integralui.splitimage.js
  version : 23.3.0
...
class IntegralUISplitImageComponent extends Component {
    constructor(props){
        super(props);
    ...
    _initProps(){
        if (this.ctrlRef && this.ctrlRef.current){
            ...
            if (this._isDefined(this.props.splitterSize))
                this.ctrlRef.current.splitterSize = this.props.splitterSize;
    ...
    _updateData(prevProps){
        if (this.ctrlRef && this.ctrlRef.current){
            ...
            if (this.props.splitterDistance !== prevProps.splitterDistance)
                this.ctrlRef.current.splitterDistance = this.props.splitterDistance;
            if (this.props.splitterSize !== prevProps.splitterSize)
                this.ctrlRef.current.splitterSize = this.props.splitterSize;
    ...
    render(){
        return (
            <iui-splitimage id={this.props.id} ref={this.ctrlRef}>
                {this.props.children}
            </iui-splitimage>
        );
    }
