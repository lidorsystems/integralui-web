...
import '../components/integralui.groupbox.js';

class IntegralUIGroupBoxComponent extends Component {
    constructor(props){
        super(props);
    ...
    render(){
        return (
            <iui-groupbox id={this.props.id} ref={this.ctrlRef}>
                {this.props.children}
            </iui-groupbox>
        );
    }
...
export default IntegralUIGroupBoxComponent;
