/*
  filename: react.integralui.button.js
  version : 23.3.0
...
import '../components/integralui.button.js';

class IntegralUIButtonComponent extends Component {
    constructor(props){
        super(props);
    ...
    render(){
        return (
            <iui-button id={this.props.id} ref={this.ctrlRef}>
                {this.props.children}
            </iui-button>
        );
    }
...
export default IntegralUIButtonComponent;
