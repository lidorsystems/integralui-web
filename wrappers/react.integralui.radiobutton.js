...
import '../components/integralui.radiobutton.js';
...
var IntegralUIRadioButtonComponent = function (_Component) {
    _inherits(IntegralUIRadioButtonComponent, _Component);

    function IntegralUIRadioButtonComponent(props) {
        _classCallCheck(this, IntegralUIRadioButtonComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIRadioButtonComponent.__proto__ || Object.getPrototypeOf(IntegralUIRadioButtonComponent)).call(this, props));
    ...
    _createClass(IntegralUIRadioButtonComponent, [{
    ...
    return IntegralUIRadioButtonComponent;
}(Component);

export default IntegralUIRadioButtonComponent;