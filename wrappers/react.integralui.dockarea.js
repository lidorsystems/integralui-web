...
import '../components/integralui.dockarea.js';
...
var IntegralUIDockAreaComponent = function (_Component) {
    _inherits(IntegralUIDockAreaComponent, _Component);

    function IntegralUIDockAreaComponent(props) {
        _classCallCheck(this, IntegralUIDockAreaComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIDockAreaComponent.__proto__ || Object.getPrototypeOf(IntegralUIDockAreaComponent)).call(this, props));
    ...
    _createClass(IntegralUIDockAreaComponent, [{
    ...
    return IntegralUIDockAreaComponent;
}(Component);

export default IntegralUIDockAreaComponent;