/*
  filename: react.integralui.radiogroup.js
  version : 23.3.0
...
class IntegralUIRadioGroupComponent extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        ...
        if (this.ctrlRef && this.ctrlRef.current){
            if (this.props.buttonChecked)
                this.ctrlRef.current.addEventListener('buttonChecked', (e) => this.props.buttonChecked(e));
    ...
    componentWillUnmount(){
        if (this.ctrlRef && this.ctrlRef.current){
            if (this.props.buttonChecked)
                this.ctrlRef.current.removeEventListener('buttonChecked', this.props.buttonChecked);
            if (this.props.enabledChanged)
    ...
    render(){
        return (
            <iui-radiogroup id={this.props.id} ref={this.ctrlRef}>
                {this.props.children}
            </iui-radiogroup>
        );
    }
