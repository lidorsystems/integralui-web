...
import '../components/integralui.radiogroup.js';
...
var IntegralUIRadioGroupComponent = function (_Component) {
    _inherits(IntegralUIRadioGroupComponent, _Component);

    function IntegralUIRadioGroupComponent(props) {
        _classCallCheck(this, IntegralUIRadioGroupComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIRadioGroupComponent.__proto__ || Object.getPrototypeOf(IntegralUIRadioGroupComponent)).call(this, props));
    ...
    _createClass(IntegralUIRadioGroupComponent, [{
        ...
        value: function componentDidMount() {
            ...
            if (this.ctrlRef && this.ctrlRef.current) {
                if (this.props.buttonChecked) this.ctrlRef.current.addEventListener('buttonChecked', function (e) {
                    return _this2.props.buttonChecked(e);
                });
        ...
        value: function componentWillUnmount() {
            if (this.ctrlRef && this.ctrlRef.current) {
                if (this.props.buttonChecked) this.ctrlRef.current.removeEventListener('buttonChecked', this.props.buttonChecked);
    ...
    return IntegralUIRadioGroupComponent;
}(Component);

export default IntegralUIRadioGroupComponent;