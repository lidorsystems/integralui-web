...
import '../components/integralui.textbox.js';
...
var IntegralUITextBoxComponent = function (_Component) {
    _inherits(IntegralUITextBoxComponent, _Component);

    function IntegralUITextBoxComponent(props) {
        _classCallCheck(this, IntegralUITextBoxComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUITextBoxComponent.__proto__ || Object.getPrototypeOf(IntegralUITextBoxComponent)).call(this, props));
    ...
    _createClass(IntegralUITextBoxComponent, [{
    ...
    return IntegralUITextBoxComponent;
}(Component);

export default IntegralUITextBoxComponent;