...
import '../components/integralui.accordion.js';
...
var IntegralUIAccordionComponent = function (_Component) {
    _inherits(IntegralUIAccordionComponent, _Component);

    function IntegralUIAccordionComponent(props) {
        _classCallCheck(this, IntegralUIAccordionComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUIAccordionComponent.__proto__ || Object.getPrototypeOf(IntegralUIAccordionComponent)).call(this, props));

        _this.ctrlRef = React.createRef();
        return _this;
    }

    _createClass(IntegralUIAccordionComponent, [{
        key: '_isCtrlDefined',
    ...
    return IntegralUIAccordionComponent;
}(Component);

export default IntegralUIAccordionComponent;