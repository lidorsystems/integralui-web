/*
  filename: react.integralui.label.js
  version : 23.3.0
...
class IntegralUILabelComponent extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        ...
        if (this.ctrlRef && this.ctrlRef.current){
            ...
            if (this.props.onKeyDown)
                this.ctrlRef.current.addEventListener('keydown', (e) => this.props.onKeyDown(e));
    ...
    componentWillUnmount(){
        if (this.ctrlRef && this.ctrlRef.current){
            ...
            if (this.props.onKeyDown)
                this.ctrlRef.current.removeEventListener('keydown', this.props.onKeyDown);
            if (this.props.onMouseDown)
    ...
    _initProps(){
        if (this.ctrlRef && this.ctrlRef.current){
            ...
            if (this._isDefined(this.props.contentSize))
                this.ctrlRef.current.contentSize = this.props.contentSize;
    ...
    render(){
        return (
            <iui-label id={this.props.id} ref={this.ctrlRef}>
                {this.props.children}
            </iui-label>
        );
    }
