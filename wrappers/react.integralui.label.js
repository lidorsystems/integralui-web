...
import '../components/integralui.label.js';
...
var IntegralUILabelComponent = function (_Component) {
    _inherits(IntegralUILabelComponent, _Component);

    function IntegralUILabelComponent(props) {
        _classCallCheck(this, IntegralUILabelComponent);

        var _this = _possibleConstructorReturn(this, (IntegralUILabelComponent.__proto__ || Object.getPrototypeOf(IntegralUILabelComponent)).call(this, props));
    ...
    _createClass(IntegralUILabelComponent, [{
        ...
        value: function componentDidMount() {
            ...
            if (this.ctrlRef && this.ctrlRef.current) {
                ...
                if (this.props.onKeyDown) this.ctrlRef.current.addEventListener('keydown', function (e) {
        ...
        value: function componentWillUnmount() {
            if (this.ctrlRef && this.ctrlRef.current) {
                ...
                if (this.props.onKeyDown) this.ctrlRef.current.removeEventListener('keydown', this.props.onKeyDown);
        ...
        value: function _initProps() {
            if (this.ctrlRef && this.ctrlRef.current) {
                ...
                if (this._isDefined(this.props.contentSize)) this.ctrlRef.current.contentSize = this.props.contentSize;
        ...
        value: function _updateData(prevProps) {
            if (this.ctrlRef && this.ctrlRef.current) {
                ...
                if (this.props.contentSize !== prevProps.contentSize) this.ctrlRef.current.contentSize = this.props.contentSize;
    ...
    return IntegralUILabelComponent;
}(Component);

export default IntegralUILabelComponent;