...
export const iuiRadioButtonLightStyle = css`
    ...
    .iui-radio-button-btn-checked {
        border-color: var(--iui-radio-button-btn-checked-border-color, #086dbf);
    }
    .iui-radio-button-btn-checked span {
        background: var(--iui-radio-button-btn-checked-content-background, #086dbf);
    }

    /* Button on Hover */
    .iui-radio-button:hover .iui-radio-button-btn {
        border-color: var(--iui-radio-button-btn-hovered-border-color, #086dbf);
    }
    .iui-radio-button:hover .iui-radio-button-btn-checked {
        border-color: var(--iui-radio-button-btn-checked-hovered-border-color, #0b7edb);
    }
    .iui-radio-button:hover .iui-radio-button-btn-checked span {
        background: var(--iui-radio-button-btn-checked-content-hovered-background, #0b7edb);
    }
`;