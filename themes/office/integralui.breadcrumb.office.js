...
export const iuiBreadCrumbOfficeStyle = css`
    ...
    .iui-breadcrumb-item-hovered .iui-breadcrumb-item-button {
        background-color: #f5f5f5;
    ...
    .iui-breadcrumb-item-selected .iui-breadcrumb-item-button {
        background-color: #e5e5e5;
        border-top: thin solid #cecece;
        border-right: thin solid #cecece;
        border-bottom: thin solid #cecece;
    ...
    @keyframes animate-breadcrumb-item-enter {
        ...
        100% { background: #d9edfd; border-color: #a5d3fa;  }
    }
