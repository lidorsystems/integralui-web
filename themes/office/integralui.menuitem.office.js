...
const iuiMenuItemOfficeStyle = css`
    ...
    .iui-contextmenuitem-root-hovered, .iui-contextmenuitem-root-selected {
        background: var(--contextmenuitem-hovered-background, transparent);
        border: var(--contextmenuitem-hovered-border, thin solid transparent);
        color: var(--contextmenuitem-hovered-color, black);

        animation-name: iui-contextmenuitem-hovered-animate-enter;
        animation-delay: 0s;
        animation-direction: normal;
        animation-duration: 0.15s;
        animation-fill-mode: forwards;
